...
STEP 6 — NOTION
`notion-create-pages` under data_source_id 966d82e0-aa69-4bb1-af02-e0dfa7eac741. Properties: "Trend / Topic" (title), "date:Date:start"=today (`date +%F`), Status="Ready", Format="Carousel"/"Single", Slides=5, "Hero Product"=exact product name(s), Caption (<br><br> between paragraphs), Hashtags, Sources="Brand content · PURYNN CERAPANO™".
